...
def parse_args():
    ...
    --input ../graph_data/douban/dictionaries/groundtruth \
    --out_dir ../graph_data/douban/dictionaries \
    --split=0.05
    """
    ...
    parser.add_argument('--split', type=float, default=0.05, help='Train/test split')
