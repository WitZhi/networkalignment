...
class FINAL(NetworkAlignmentModel):
    ...
    def __init__(self, source_dataset, target_dataset, H=None, alpha=0.82, maxiter=30, tol=1e-4, train_dict=None):
        ...
        self.A1 = np.array(source_dataset.get_adjacency_matrix())
        self.A2 = np.array(target_dataset.get_adjacency_matrix())
        self.alpha = alpha
    ...
    def align(self):
        ...
        self.N1 = np.array(normalize(self.N1))
        self.N2 = np.array(normalize(self.N2))
